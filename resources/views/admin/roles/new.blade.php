<x-admin-layout>
    ...
    <div class="container space-x-4">
        <x-splade-form :action="route('admin.roles.store')" class="space-y-4">
            ...
            {{-- <x-splade-select name="permissions[]" label="Assign Permissions" :options="$permissions" multiple relation
                choices /> --}}
            <x-splade-checkboxes name="permissions" label="Permissions" :options="$permissions" relation
                inline />
